...
- **Operation ID:** `get_median_exon_expression_api_v2_expression_medianExonExpression_get`
...
**Content Types:**
- **application/json**
  - **Schema:** Reference: `#/components/schemas/PaginatedResponse_MedianExonExpression_`
