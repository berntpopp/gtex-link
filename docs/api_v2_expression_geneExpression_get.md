...
- **Operation ID:** `get_gene_expression_api_v2_expression_geneExpression_get`
...
- **`attributeSubset`**
  ...
  - **Schema:** Reference: `#/components/schemas/DonorAttribute`
...
**Content Types:**
- **application/json**
  - **Schema:** Reference: `#/components/schemas/PaginatedResponse_GeneExpression_`
