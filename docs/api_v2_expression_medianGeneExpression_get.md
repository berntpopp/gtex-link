...
- **Operation ID:** `get_median_gene_expression_api_v2_expression_medianGeneExpression_get`
...
**Content Types:**
- **application/json**
  - **Schema:** Reference: `#/components/schemas/PaginatedResponse_MedianGeneExpression_`
