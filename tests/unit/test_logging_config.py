...
class TestLoggingHelpers:
    ...
    def test_log_cache_operation(self):
        ...
        log_cache_operation(logger=mock_logger, operation="get", key="test_key", hit=True, size=100)
    ...
    def test_log_server_startup_with_host_port(self):
        ...
        log_server_startup(logger=mock_logger, mode="http", host="127.0.0.1", port=8000)
    ...
    def test_log_server_startup_without_host_port(self):
        ...
        log_server_startup(logger=mock_logger, mode="stdio")
    ...
    def test_log_error_with_context_with_context(self):
        ...
        log_error_with_context(
            logger=mock_logger, error=error, operation="gene_search", context=context
        )
    ...
    def test_log_error_with_context_without_context(self):
        ...
        log_error_with_context(logger=mock_logger, error=error, operation="gene_search")
